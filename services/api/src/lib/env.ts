...
export const ENV = {
	...
	// SECURITY: Never use hardcoded defaults in code - always use environment variables
	FLOW_ADMIN_SIGN_SECRET: process.env.FLOW_ADMIN_SIGN_SECRET || "",
	...
	// SECURITY: Default to empty string to ensure explicit configuration is required
