...
> 💡 **VIBE-CODED**: 🦾 All code in this project was generated by _GPT-5_ and _Composer-1_ models! This repo is  thoroughly strung together with good vibes, coffee, and Flow Actions. 🎨⚡️🧃
...
- **On-chain contracts** emit events directly to backend services.
- **Backend pipeline**: Ingestor → Normalizer → Indexer. Data and events flow via NATS JetStream.
- **Distributor** consumes jobs from NATS and posts results/updates.
- **ScyllaDB** stores event/index data. **Prometheus/Grafana** provide metrics and dashboards.
- **Next.js frontend** reads from the API (GraphQL/REST).

_This diagram reflects the real data and events flow between platform components for clarity._
